...
rightpx_X=180    #right starting pixel
leftpx_X=140     # left starting pixel
...
def check_upper():
        ...
        for p in pixels:
                ...
                r1=blur[190,rightpx_X+inc]
                l1=blur[190,leftpx_X-inc]

                blur = cv2.rectangle(blur,(rightpx_X+inc,186),(rightpx_X+(inc+5),190),(0,0,255),1) #rigth1
                blur = cv2.rectangle(blur,(leftpx_X-(inc+5),186),(leftpx_X-inc,190),(0,0,255),1)
